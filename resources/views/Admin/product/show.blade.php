    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row mb-2">
                <div class="col-sm-3">
                    <a href="{{route('admin.product.edit',['id'=>$data->id])}}"><button type="button" class="btn btn-primary btn-lg">Ürünü Düzenle</button></a>
                </div>
                <div class="col-sm-3">
                    <a href="{{route('admin.product.destroy',['id'=>$data->id])}}" onclick="return confirm('Deleting !! Are you sure ?')" ><button type="button" class="btn btn-danger btn-lg">Ürünü Sil</button></a>
                </div>
            </div>
            <div class="row mt">
                <div class="col-lg-12">
                    <table class="table table-striped">
                        ...
                        <tr>
                            <th style="width: 200px;">Ürün Detayı</th>
                            <td> {{$data->detail}} </td>
                        </tr>
                        <tr>
