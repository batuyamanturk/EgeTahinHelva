    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row mb-2">
                <div class="col-sm-3">
                    <a href="{{route('admin.gallery.destroy',['id'=>$data->id])}}" onclick="return confirm('Deleting !! Are you sure ?')" ><button type="button" class="btn btn-danger btn-lg">Resimi Sil</button></a>
                </div>
            </div>
            <div class="row mt">
                <div class="col-lg-12">
